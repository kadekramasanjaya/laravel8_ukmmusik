                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                            ...
                            <tbody>
                                ...
                                @foreach ($peminjaman as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->tanggal }}</td>
                                        <td><img src="{{ url('foto_peminjaman/' . $data->foto) }}" width="80px">
                                        </td>
                                        <td>
                                            <a href="/peminjaman/detailpeminjaman/{{ $data->id_barang }}"
                        ...
                        <div class="row no-print">
                            <div class="col-12">
                                <a href="/peminjaman/addpeminjaman" class="btn btn-primary btn-sm">Add</a>
                                <br>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <a href="/peminjaman/delete/{{ $data->id_barang }}" class="btn btn-outline-light">Yes</a>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
