...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card card-solid">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <h3>{{ $mahasiswaukmmusikundiksha->nama }}</h3>
                        <div class="bg-red py-2 px-3 mt-4">
                            <h2>
                                {{ $mahasiswaukmmusikundiksha->nim }}
                            </h2>
                        </div>
                        <div class="bg-yellow py-2 px-3 mt-4">
                            <h2>
                                {{ $mahasiswaukmmusikundiksha->prodi }}
                            </h2>
                        </div>
                        <div class="bg-green py-2 px-3 mt-4">
                            <h2>
                                {{ $mahasiswaukmmusikundiksha->jabatan }}
                            </h2>
                        </div>
                        <div class="bg-blue py-2 px-3 mt-4">
                            <h2>
                                {{ $mahasiswaukmmusikundiksha->status }}
                            </h2>
                        </div>
                    </div>
                </div>
        ...
        <!-- /.card -->
        <tr>
            <th><a href="/mahasiswaukmmusikundiksha" class="btn btn-success tbn-sm">Kembali</a></th>
        </tr>
    @endsection
