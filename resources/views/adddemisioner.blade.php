...
@section('content')
    <form action="/demisionerukmmusikundiksha/insertdemisioner" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Tambah Demisioner</h3>
